...
class PilotSerializer(serializers.ModelSerializer):
    ...
    def validate_name(self, value):
        ...
        if " " not in value:
            raise serializers.ValidationError(
                "O nome precisa ser composto por um sobrenome!"
            )  # noqa:E501
    ...
    def validate_age(self, value):
        if value < 18:
            raise serializers.ValidationError(
                "O piloto precisa ter uma idade igual ou superior a 18 anos!"
            )  # noqa:E501
    ...
    def validate_number(self, value):
        if value > 200:
            raise serializers.ValidationError(
                "O número do piloto precisa ser menor que 200!"
            )  # noqa:E501
    ...
    def validate_automaker(self, value):
        ...
        if count_automakers > 1:
            raise serializers.ValidationError(
                "Infelizmente a montadora só pode ter dois pilotos por temporada!"
            )  # noqa:E501
    ...
    def validate_category(self, value):
        ...
        if not obj:
            raise serializers.ValidationError(
                "Infelizmente a categoria enviada não existe!"
            )  # noqa:E501
